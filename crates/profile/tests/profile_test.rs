...
fn click_at_then_type_key_types_into_a_real_focused_input() {
  let page_addr =
    serve_html_once(r##"<input id="field"><style>#field { width: 150px; height: 30px; }</style>"##);
...
fn a_pages_console_output_is_drainable_over_the_protocol() {
  ...
  let html =
    r#"<script>console.log('boot'); console.warn('careful', 7); console.error('bad');</script>"#;
