//! `innerHTML`/`outerHTML`/`insertAdjacentHTML` — split out from
//! `content/mod.rs`.
...
use super::super::mutation::{first_child_of, next_sibling_of};
use super::super::node_registry::dom_opaque;
use super::super::node_registry::node_id;
...
pub(in super::super) unsafe fn define_inner_outer_html(
    ctx: *mut sys::JSContext,
    proto: sys::JSValue,
) {
