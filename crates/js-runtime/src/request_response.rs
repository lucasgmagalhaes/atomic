...
pub(crate) unsafe fn register(ctx: *mut sys::JSContext) {
  ...
  let headers_class_id =
    crate::class_registry::ensure_class(sys::JS_GetRuntime(ctx), HEADERS_CLASS_KIND, &headers_def);
  ...
  let request_class_id =
    crate::class_registry::ensure_class(sys::JS_GetRuntime(ctx), REQUEST_CLASS_KIND, &request_def);
